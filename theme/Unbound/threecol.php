...
<body id="<?php get_page_slug(); ?>">
	...
	<div id="content-outer" class="clear"><div id="content-wrapper">
		...
		<!-- column-three -->
		<div class="col-three">
			<h3>Getting an Editable Third Column</h3>	
			<p>To make this area of the page editable through the Getsimple backend you can do one of three things:
			<ul><li>Make a Component and insert it into the template</li>
			<li>Make a Page within a Page</li>
			<li>Use the Simple Input Tabs Plugin</li></ul>
			There are full instructions on the <a href=http://timbowgs.bplaced.net/unbound/three-columns/>demo pages</a>.</p>
		</div>	
