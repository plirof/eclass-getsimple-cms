...
<body id="<?php get_page_slug(); ?>" >
	...
	<div id="wrapper">
		<div id="sidebar">
			...
			<a href='http://orkun.me/'>Light</a> Theme. Valid&nbsp;<a href="http://validator.w3.org/check?uri=referer">HTML5</a>&nbsp;and&nbsp;<a href="http://jigsaw.w3.org/css-validator/check/referer?profile=css3&amp;vextwarning=true">CSS3</a></p>	
		</div>
		<div id="content">
			<h1><?php get_page_title(); ?></h1>	
			<div class="page-text">
				<?php get_page_content(); ?>
				<p class="page-meta">Published on &nbsp;<?php get_page_date('F jS, Y'); ?></p>
			</div>
		</div>
		<div class="clear"></div>
	</div>
