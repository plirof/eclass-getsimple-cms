...
<body id="<?php get_page_slug(); ?>" >
	...
	<div id="wrapper">	
		...
		<div class="clear"></div>
		<div id="footer_txt"><?php echo date('Y'); ?>&nbsp;&copy;&nbsp;<?php get_site_name(); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php get_site_credits(); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://orkun.me/">AcidMind</a>&nbsp;Theme&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php get_site_url(); ?>admin">LOGIN</a></div>
		<?php get_footer(); ?>
