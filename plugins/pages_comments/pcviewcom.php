...
//// START see logs
	...
	foreach ($log_data as $log) {
		...
		foreach($log->children() as $child) {
                ...
                //comments
        	echo '<table border=1 style="line-height: 11px; margin-bottom: 0px; width: 100%;">';
			  ...
			  echo '<td style="border-bottom: 5px;width: 45px; padding: 0px; line-height: 11px;"><b>'.i18n_r('pages_comments/pc_vote').': </b>'.$pcrating.'</td>';
        	echo '</table>';
        	echo '<table border=2 style="line-height: 11px; width: 100%;">';
                    echo '</tr>';
                    echo '<tr>';
                    ...
                    //ΑΠΑΝΤΗΣΗ			
                    echo '<tr>';
                          echo '<td style="border-bottom: 4px solid text-align: right; width: 45px; padding: 1px; line-height: 14px;"><b>'.i18n_r('pages_comments/Cm').':</b></td><td colspan="3" style="padding: 1px; line-height: 14px;">'. html_entity_decode($comcom).'</td>';
                    echo '</tr>';
                    //email ,                    
                    echo '<tr>';
                    ...
                    echo '<tr style="border-bottom: 4px solid #CCCCCC;">';
